...
namespace Atlas.Seed.Data
{
    public class SeedData
    {
        ...
        private static void AddOriginNavigation()
        {
            ...
            Module originModule = new() { Name = "Origin", Icon = "BookGlobe", Order = 4, Permission = Auth.DOCUMENT_READ };
        ...
        private static void AddCommercial()
        {
            ...
            Module commercialModule = new() { Name = "Commercial", Icon = "BuildingBank", Order = 5, Permission = Auth.COMMERCIAL_READ };
