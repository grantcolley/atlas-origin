            ...
            [
                ...
                new DocumentConfigParagraph()
                {
                    ...
                    DocumentParagraph = new DocumentParagraph
                    {
                        ...
                        Contents =
                        [
                            new DocumentContent { DocumentContentId = 1, Order = 1, Name = ContentNames.LOGO, RenderCellCode = TableCellCodes.COMPANY_LOGO, ContentType = DocumentContentType.Image, Source = Path.Combine(outputLocation, "logo.png"), ImageHeight = 15, ImageWidth = 35 },
                ...
                new DocumentConfigParagraph()
                {
                    ...
                    DocumentParagraph = new DocumentParagraph
                    {
                        ...
                        Contents =
                        [
                            new DocumentContent { DocumentContentId = 17, Order = 17, Name = ContentNames.SIGNATURE, RenderCellCode = TableCellCodes.SIGNATURE_DETAILS, ContentType = DocumentContentType.Image, Source = Path.Combine(outputLocation, "signature.png"), ImageHeight = 15, ImageWidth = 35 },
