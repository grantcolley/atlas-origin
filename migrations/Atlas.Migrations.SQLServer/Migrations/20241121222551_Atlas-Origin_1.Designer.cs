...
namespace Atlas.Migrations.SQLServer.Migrations
{
    ...
    [Migration("20241121222551_Atlas-Origin_1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Commercial.Core.Models.Company", b =>
                {
            ...
            modelBuilder.Entity("Commercial.Core.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("Commercial.Core.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("Origin.Core.Models.Document", b =>
                {
                    ...
                    b.Property<int?>("ConfigDocumentConfigId")
                        .HasColumnType("int");

                    b.Property<int>("DocumentGeneratorType")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConfigDocumentConfigId");
            ...
            modelBuilder.Entity("Origin.Core.Models.DocumentConfigParagraph", b =>
                {
                    b.Property<int>("DocumentConfigParagraphId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DocumentConfigParagraphId"));
                    ...
                    b.HasKey("DocumentConfigParagraphId");

                    b.HasIndex("DocumentConfigId");

                    b.HasIndex("DocumentParagraphId");

                    b.ToTable("DocumentConfigParagraphs");
                });
            ...
            modelBuilder.Entity("Commercial.Core.Models.Product", b =>
                {
                    b.HasOne("Commercial.Core.Models.Customer", "Customer")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Origin.Core.Models.Document", b =>
                {
                    b.HasOne("Origin.Core.Models.DocumentConfig", "Config")
                        .WithMany()
                        .HasForeignKey("ConfigDocumentConfigId");
            ...
            modelBuilder.Entity("Origin.Core.Models.DocumentConfigParagraph", b =>
                {
                    b.HasOne("Origin.Core.Models.DocumentConfig", null)
                        .WithMany("ConfigParagraphs")
                        .HasForeignKey("DocumentConfigId");

                    b.HasOne("Origin.Core.Models.DocumentParagraph", "DocumentParagraph")
                        .WithMany()
                        .HasForeignKey("DocumentParagraphId");

                    b.Navigation("DocumentParagraph");
                });
